...
<p class="Parrafo">“LA DEPENDENCIA” PAGARÁ A “EL PROVEEDOR” COMO CONTRAPRESTACIÓN POR LOS SERVICIOS OBJETO DE ESTE CONTRATO, LA CANTIDAD DE <strong>${{ $requisicion->total }}, IVA INCLUIDO</strong>, MENOS LAS RETENCIONES
QUE CONFORME A LA LEY PROCEDAN.
</p>
@else
<p class="Parrafo">
“LA DEPENDENCIA” PAGARÁ A “EL PROVEEDOR” COMO CONTRAPRESTACIÓN POR LOS SERVICIOS OBJETO DE ESTE CONTRATO, LA CANTIDAD DE <strong>${{ $requisicion->total }}, IVA INCLUIDO</strong>, IMPORTE QUE SE CUBRIRÁ EN CADA UNO DE LOS EJERCICIOS FISCALES, DE ACUERDO A LO SIGUIENTE:
</p>
<div>
<table class="tabla">
<thead>
...
PRESTACIÓN DEL SERVICIO, POR LO QUE “EL PROVEEDOR” NO PODRÁ AGREGAR NINGÚN COSTO EXTRA Y LOS PRECIOS SERÁN INALTERABLES DURANTE LA VIGENCIA DEL PRESENTE CONTRATO.
</p>
...
AVANCE (PAGOS PROGRESIVOS), CONFORME A LOS SERVICIOS EFECTIVAMENTE PRESTADOS Y A ENTERA SATISFACCIÓN DEL ADMINISTRADOR DEL CONTRATO Y DE ACUERDO CON LO ESTABLECIDO.
</p>
<p class="Parrafo">
...
<p class="Parrafo">
EL PAGO DE LA PRESTACIÓN DE LOS SERVICIOS RECIBIDOS, QUEDARÁ CONDICIONADO AL PAGO QUE <strong>“EL PROVEEDOR” </strong>DEBA EFECTUAR POR CONCEPTO DE PENAS CONVENCIONALES Y, EN SU CASO, DEDUCTIVAS.
</p>
<h6 class="subtitulo">
QUINTA. LUGAR, PLAZOS Y CONDICIONES DE LA PRESTACIÓN DE LOS SERVICIOS.
</h6>
<p class="Parrafo">
A PRESTACIÓN DE LOS SERVICIOS, SE REALIZARÁ CONFORME A LOS PLAZOS, CONDICIONES Y ENTREGABLES ESTABLECIDOS POR “LA ENTIDAD”.
</p>
<p class="Parrafo">
...
@if ($requisicion->garantia1_id == 2 || ($requisicion->garantia_2_id == 2 || $requisicion->garantia_3_id == 2))
<p class="Parrafo">
<strong>“EL PROVEEDOR”</strong> SE OBLIGA CON <strong>“LA DEPENDENCIA” </strong>A ENTREGAR AL INICIO DE LA PRESTACIÓN DEL SERVICIO,
...
@else
<p class="Parrafo">
PARA LA PRESTACIÓN DE LOS SERVICIOS MATERIA DEL PRESENTE CONTRATO, REQUIERE QUE “EL PROVEEDOR” PRESENTE UNA CARTA GARANTÍA POR LA CALIDAD DE LOS SERVICIOS CONTRATADOS.
</p>
@endif
<h6 class="SubTitulo">
NOVENA. GARANTÍA
...
<h6 class="subtitulo">DÉCIMA SEGUNDA. ADMINISTRACIÓN, VERIFICACIÓN, SUPERVISIÓN Y ACEPTACIÓN DE LOS SERVICIOS</h6>
<p class="Parrafo">
...
<p class="Parrafo">
LOS SERVICIOS SE TENDRÁN POR RECIBIDOS PREVIA REVISIÓN DEL ADMINISTRADOR DEL PRESENTE CONTRATO, LA CUAL CONSISTIRÁ EN LA VERIFICACIÓN DEL CUMPLIMIENTO DE LAS ESPECIFICACIONES ESTABLECIDAS Y EN SU CASO EN LOS
ANEXOS RESPECTIVOS, ASÍ COMO LAS CONTENIDAS EN LA PROPUESTA TÉCNICA.
</p>
<p class="Parrafo">
<strong>“LA DEPENDENCIA”</strong>, A TRAVÉS DEL ADMINISTRADOR DEL CONTRATO, RECHAZARÁ LOS SERVICIOS, QUE NO CUMPLAN LAS ESPECIFICACIONES ESTABLECIDAS EN ESTE CONTRATO Y EN SUS ANEXOS, OBLIGÁNDOSE “EL PROVEEDOR”
...
<p class="Parrafo">
<strong>“LA DEPENDENCIA”</strong>, A TRAVÉS DEL ADMINISTRADOR DEL CONTRATO, PODRÁ ACEPTAR LOS SERVICIOS QUE
...
RESPECTIVOS, LAS CUALES SE CALCULARÁN SOBRE EL MONTO DE LOS SERVICIOS, PROPORCIONADOS EN FORMA PARCIAL O DEFICIENTE. LAS
...
DE LOS SERVICIOS, OBJETO DEL PRESENTE CONTRATO, CONFORME A LO ESTABLECIDO EN EL ANEXO PARTE
...
DE ATRASO SOBRE LA PARTE DE LOS SERVICIOS NO PRESTADOS, DE CONFORMIDAD
...
@if (1 > 1)
<p class="Parrafo">
PARA LA PRESTACIÓN DE LOS SERVICIOS MATERIA DEL PRESENTE CONTRATO, NO SE REQUIERE QUE <strong>“EL PROVEEDOR”</strong> CONTRATE UNA PÓLIZA DE SEGURO POR RESPONSABILIDAD CIVIL.
</p>
@else
<p class="Parrafo">
...
<p class="Parrafo">
<strong>“EL PROVEEDOR”</strong> SE OBLIGA BAJO SU COSTA Y RIESGO, A TRASPORTAR LOS BIENES E INSUMOS NECESARIOS PARA LA
...
SERVICIOS, DE MANERA TEMPORAL, QUEDANDO OBLIGADO A PAGAR A <strong>“EL PROVEEDOR”</strong>, AQUELLOS SERVICIOS QUE
...
Y PAGARÁ A <strong>“EL PROVEEDOR”</strong> LA PARTE PROPORCIONAL DE LOS SERVICIOS PRESTADOS, ASÍ COMO LOS GASTOS NO
...
SERVICIOS, EL PROCEDIMIENTO INICIADO QUEDARÁ SIN EFECTO, PREVIA ACEPTACIÓN Y VERIFICACIÓN DE <strong>“LA DEPENDENCIA”</strong> DE QUE CONTINÚA VIGENTE LA NECESIDAD DE LA PRESTACIÓN DE LOS SERVICIOS, APLICANDO, EN SU CASO,
...
INTERVIENEN EN LA PRESTACIÓN DEL SERVICIO, DESLINDANDO DE TODA RESPONSABILIDAD A <strong>“LA DEPENDENCIA”</strong> RESPECTO DE CUALQUIER RECLAMO QUE EN SU CASO PUEDAN EFECTUAR SUS TRABAJADORES, SEA DE ÍNDOLE
...
<p class="Parrafo">
<strong>“LAS PARTES”</strong> SE OBLIGAN A SUJETARSE ESTRICTAMENTE PARA LA PRESTACIÓN DE LOS SERVICIOS OBJETO DEL
